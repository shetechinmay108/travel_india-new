...
<body>
    <div class="main">
        ...
        <div class="page2"  >
           <div class="text">
            <h1>Shereé planned this trip because she needed
                awareness and healing, to which the other Peaches
                said, “Best of luck to you.” Drew gets very worked up
                at the first dinner about a home chef who is suing her
                for one thousand dollars, to which Kenya asks if they
                can all just pool their money to settle..</h1>
           </div>
           <div class="middle2">
            <div class="middle2-part1">
                <img src="https://cdn.prod.website-files.com/66be216df5f5c498bc873efb/66dec8d569dc9fde950b8ac4_RHOA_S15E11-12_Maybe%20the%20W%20Algarve%20-%20this%20article%20references%20the%20W%20Hotel_2-topaz.avif" alt="">
            </div>
            <div class="middle2-part2">
                <h3>The next morning, Kenya takes a spill on some wet
                    concrete and is taken away in an ambulance. And
                    that is the story of how her friend Kandi ended up
                    spending her one full day in Portugal at the
                    hospital. There is a beautiful sound bath that
                    devolves into an argument over whether Drew is an
                    undercover lesbian.</h3>
            </div>
           </div>
           <div class="middle3">
            <div class="middle3-part1">
                <h3>The gals do pull it together to dance the last night
                    away with some Portuguese folk dancers, or
                    “pilgrims” as Drew calls them..</h3>
                    <div class="button1">
            ...
            <div class="middle3-part2">
                <img src="https://cdn.prod.website-files.com/66be216df5f5c498bc873efb/66dec8d8367d79a17c67cd6e_RHOA_S15E11-12_Maybe%20the%20W%20Algarve%20-%20this%20article%20references%20the%20W%20Hotel_3-topaz.avif" alt="">
            </div>
           </div>
           <div class="middle4">
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="W-Algarve.php">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="The-Kelly-Birmingham.php">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="Blue-Ridge-Chalet.php">read more</a></h4>

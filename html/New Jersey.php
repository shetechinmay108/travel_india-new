           ...
           ?>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    ...
                    <h4><a href="./new-jersy/Ballinlough-Castle.php">read more</a></h4> 
                </div>
            </div>
            <div class="booking">
                <div class="book-part1">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="./new-jersy/Nashville-Pad.php">read more</a></h4> 
                </div>
            </div>
            <div class="booking">
                <div class="book-part1">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="./new-jersy/Hamptons-Estate.php">read more</a></h4> 
                </div>
            </div>
        </div>
        <div class="page3"></div>

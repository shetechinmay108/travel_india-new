...
<body>
    <div class="main">
        <div class="page1">
            ...
            <div class="middle">
                <h1>Dawn Ranch</h1>
                <br><h4>Guerneville, California</h4>
             </div>
             <div class="header">
        ...
        <div class="page2" id="content" >
           <div class="text">
            <h1>If only Heather could protect all of the ladies' feelings
                as well as she protects her clothing packed in
                individual sheets of white tissue paper.</h1>
           </div>
           <div class="middle2">
            <div class="middle2-part1">
                <img src="https://cdn.prod.website-files.com/66be216df5f5c498bc873efb/66daf17c79769b93a9666b58_RHOC_S17E4-6_Alpine%20Falls%20Ranch_1.avif" alt="">
            </div>
            <div class="middle2-part2">
                <h3>Heather gathered the women in her PJ and jetted off
                    to Guerneville so she could host a fundraiser for
                    Family Equality, debut her champagne collaboration
                    with GEM, and leverage the ladies to walk in her
                    “business casual basics” fashion show. And yet,
                    Heather was not the centerpiece of the trip. No, the
                    primary event would be the ongoing fallout whenever
                    Shannon Storms Beador and Alexis Bellino share a
                    space, even a redwood forest...</h3>
            </div>
           </div>
           <div class="middle3">
            <div class="middle3-part1">
                <h3>See, Alexis is dating Shannon’s ex, Johnny J, and
                    while Shannon believes JJ did her dirty, Alexis claims
                    the opposite and has the videos to prove it. The jury is
                    out on whether John Janssen is a “good guy,” but
                    everyone can agree that Tamra put her finger in
                    Emily’s butt.</h3>
                    <div class="button1">
            ...
            <div class="middle3-part2">
                <img src="https://cdn.prod.website-files.com/66be216df5f5c498bc873efb/66f44ae9fcc78f0e02718209_RHOC_S18E9-10_Dawn%20Ranch_3-topaz-upscale-2000w.avif" alt="">
            </div>
           </div>
           <div class="middle4">
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="The-May-Fair-Hotel.php">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="Elizabeth-Home.php">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="Dawn-Ranch.php">read more</a></h4>

...
<head>
    ...
    <title>Ramona's Vacation House</title>
...
<body>
    <div class="main">
        <div class="page1">
            ...
            <div class="middle">
                <h1> "Ramona's" Vacation House</h1>
                <br><h4>The Hamptons, New York</h4>
             </div>
             <div class="header">
        ...
        <div class="page2"  >
           <div class="text">
            <h1>The Housewives' trip is marred by constant fighting over their status on The Real Housewives of New York City, overshadowing the comfort of Ramona's mansion and the hospitality provided..</h1>
           </div>
           <div class="middle2">
            <div class="middle2-part1">
                <img src="https://cdn.prod.website-files.com/66be216df5f5c498bc873efb/66db17d79c52bf500ff67c1d_RHONY_S13E3-4_Hamptons-2.avif" alt="">
            </div>
            <div class="middle2-part2">
                <h3>From the jump, Leah is angry that Heather Thomson
                    has been invited to join them despite having talked
                    trash about some of the cast members on her
                    podcast, and makes it her mission to make everyone
                    else mad about it too. Sonja is angry that Ramona’s
                    mortgage is being held by Wells Fargo instead of the
                    bank she married.</h3>
            </div>
           </div>
           <div class="middle3">
            <div class="middle3-part1">
                <h3>What of her Morgan clout? Only new girl Eboni has a
                    new and interesting beef, taking offense at how
                    Ramona refers to “the help”. As she explains to
                    Ramona as they enjoy a winery tasting, her
                    grandmother was a domestic worker so she is
                    sensitive about it. Ramona nods and blinks, and
                    then excuses herself to have diarrhea in the gift
                    shop bathroom.</h3>
                    <div class="button1">
            ...
            <div class="middle3-part2">
                <img src="https://cdn.prod.website-files.com/66be216df5f5c498bc873efb/66db17dabbc5abce8cb7a7c4_RHONY_S13E3-4_Hamptons-3.avif" alt="">
            </div>
           </div>
           <div class="middle4">
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="./Erin's-House.html">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="./long-bay-villas.html">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="./RamonasHouse.html">read more</a></h4>

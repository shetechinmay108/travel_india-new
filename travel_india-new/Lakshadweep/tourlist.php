                ...
                <div class="middle4">
                    <div class="booking">
                        ...
                        <div class="book-part4"  >
                         <h4><a href="../book_files/book_form.php?Id=<?php echo $row['TourPackage_Id']; ?>">Book now</a></h4>
                         <h4><a href="../book_files/book_tour.php?Id=<?php echo $row['TourPackage_Id']; ?>">read more</a></h4> 
                </div>
                    </div>
                </div>

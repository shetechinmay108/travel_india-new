...
<body>
    <div class="main">
        ...
        <div class="page2"  >
           <div class="text">
            <h1>What constitutes a “remodel?” Who can say, really?
                Has Erin’s kitchen been remodeled, as she claims? Or
                is this a new island and fixtures? Or, perhaps, this is
                not a freshening up, but the final steps of a Ship of
                Theseus style rebuild in which the original parts of
                the house are all slowly replaced?.</h1>
           </div>
           <div class="middle2">
           ...
           <div class="middle4">
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="Ballinlough-Castle.php">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="Nashville-Pad.php">read more</a></h4>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="Homptons-Estate.php">read more</a></h4>

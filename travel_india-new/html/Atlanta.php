        ...
        <div class="page1">
            ...
            <div class="nav">
             ...
             <div class="header" style="bottom: 25%;">
                <h1 class="header-part1" style="font-size: 30vw;">Atlanta</h1>
             </div>
           ...
           ?>
            ...
            <div class="booking">
                ...
                <div class="book-part4"  >
                    ...
                    <h4><a href="./Atlanta/W-Algarve.php">read more</a></h4> 
                </div>
            </div>
            <div class="booking">
                <div class="book-part1">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="./Atlanta/The-Kelly-Birmingham.php">read more</a></h4> 
                </div>
            </div>
            <div class="booking">
                <div class="book-part1">
                ...
                <div class="book-part4"  >
                    <h4><a href="#">Book now</a></h4>
                    <h4><a href="./Atlanta/Blue-Ridge-Chalet.php">read more</a></h4> 
                </div>
            </div>
        </div>
        <div class="page3"></div>

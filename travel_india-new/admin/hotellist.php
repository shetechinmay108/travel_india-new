    ...
    <div class="middle4">
        <div class="booking">
            ...
            <div class="book-part4"> 
                <button style="width: 75px; height:30px;"><a href="update_hotel.php?id=<?php echo $row['Hotel_Id'] ?>" style="text-decoration:none;">Update</a> </button>
                <button style="width: 75px; height:30px;"><a href="hotellist.php?ID=<?php echo $row['Hotel_Id'] ?>" style="text-decoration:none; color:red;">Delete</a></button>
            </div>
        </div>
    </div>
    <?php

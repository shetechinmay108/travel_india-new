    ...
    <div class="middle4">
        <div class="booking">
            ...
            <div class="book-part4"> 
                <button style="width: 75px; height:30px;"><a href="update_tour.php?id=<?php echo $row['TourPackage_Id'] ?>" style="text-decoration:none;">Update</a> </button>
                <button style="width: 75px; height:30px; color:red;"><a href="tourlist.php?ID=<?php echo $row['TourPackage_Id'] ?>" style="text-decoration:none; color:red;" >Delete</a></button>
            </div>
        </div>
    </div>
    <?php
